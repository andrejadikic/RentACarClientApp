...
import gui.fx.app.restclient.dto.VehicleListDto;
...
//            VehicleListDto accommodationList = reservationServiceRestClient.getAvailable(reservationView.getTfCity().getText(),
